...
INSERT INTO `scott`.`emp` (`EMPNO`, `ENAME`, `JOB`, `MGR`, `HIREDATE`, `SAL`, `COMM`, `DEPTNO`) VALUES ('3', 'Alice', 'RH', '3', '2000-12-26', '20000', '4684', '2');
INSERT INTO `scott`.`emp` (`EMPNO`, `ENAME`, `JOB`, `MGR`, `HIREDATE`, `SAL`, `COMM`, `DEPTNO`) VALUES ('4', 'Rebeca', 'Acc', '4', '1998-12-8', '26000', '1500', '3');
