...
from routes.dept import dept_bp, new_dept_bp, edit_dept_bp, delete_dept_bp
from routes.emp import emp_bp, new_emp_bp, edit_emp_bp, delete_emp_bp
...
app.register_blueprint(delete_dept_bp)
